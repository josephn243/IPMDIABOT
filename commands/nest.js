module.exports = {
    ...
    async execute(message, args, Discord, client) {
        ...
        let embed = new Discord.MessageEmbed()
            .setColor('#CC373C')
            .setTitle( `${user.nickname} has started an AFK check for The Nest`)
            .setThumbnail('https://i.imgur.com/QA1xlFQ.png')
            .setDescription('React appropriately below')
            .addFields(
                {name: 'To Participate', value: `${nest}`,inline: true},
