module.exports = {
    ...
    async execute(message, args, Discord, client) {
        ...
        let embed = new Discord.MessageEmbed()
            .setColor('#000000')
            .setTitle( `${user.nickname} has started an AFK check for The Shatters`)
            ...
            .addFields(
                {name: 'To Participate', value: `${shatters}`,inline: true},
                {name: 'Classses', value: `${knight} ${warrior} ${paladin}${trickster}${mystic}`},
                {name: 'Status Effects', value: ` ${t2orb} ${slow} ${paralyze} ${daze} ${armorbreak} ${expose} ${mseal} ${fungaltome}  `, inline:true},
