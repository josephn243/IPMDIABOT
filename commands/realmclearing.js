module.exports = {
    ...
    async execute(message, args, Discord, client) {
        ...
        let embed = new Discord.MessageEmbed()
            .setColor('#4A4A4A')
            .setTitle( `${user.nickname} has started an AFK check for realm clearing`)
            .setThumbnail('https://i.imgur.com/oR1wqQ3.png')
            .setDescription('React appropriately below')
            .addFields(
                {name: 'To Participate', value: `${dungeonportal}`,inline: true},
        ...
        messageEmbed.react(dungeonportal);
