module.exports = {
    ...
    async execute(message, args, Discord, client) {
        ...
        let embed = new Discord.MessageEmbed()
            .setColor('#EDFF00')
            .setTitle( `${user.nickname} has started a headcount for a Tomb of the Ancients run`)
            .setThumbnail('https://i.imgur.com/6VuYOsy.png')
            .setDescription(`${tomb} if you can participate\n ${paralyze}${knight} for paralyze/stuns \n ${trickster} if you can rush `)
            .setTimestamp()
            .setFooter('© IPMDIABOD');
