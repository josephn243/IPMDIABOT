module.exports = {
    ...
    async execute(message, args, Discord, client) {
        ...
        let embed = new Discord.MessageEmbed()
            .setColor('#CC373C')
            .setTitle( `${user.username} has started a headcount for a Nest run`)
            .setThumbnail('https://i.imgur.com/QA1xlFQ.png')
            .setDescription(`${nest} if you can participate \n ${knight}${slow}${daze}${mseal} for stun/slow/daze/mseal `)
            .setTimestamp()
            .setFooter('© IPMDIABOD');
